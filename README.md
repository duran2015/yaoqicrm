...
## Account Plan 与代表首页演示

- 进入“客户策略”，打开任一活动状态 Account Plan，在“客户策略”卡片点击“编辑策略”，可直接修改业务目标、现状判断、核心策略和成功标准。保存不会改变产品、关系人或里程碑。
- 首页切换到 `陈静 YG1005`，可同时演示今日安排、开始拜访和推荐客户。
- 首页切换到 `张伟 YG1004`，可演示逾期跟进、高优先级提示和创建复访。
- 首页切换到地区经理，代表个人工作台隐藏，继续显示原有团队聚合仪表盘。
